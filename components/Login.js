...
export default function LoginButton() {
  ...
  return (
    <div className="text-center">
      ...
      <h2 className="text-2xl font-semibold text-gray-600 mb-6">AI Prank Call App</h2>
      <div className="relative w-64 h-64 mb-10 mx-auto transform transition duration-500 hover:scale-110">
        <Image
          src="/prank.png"
          alt="Logo"
          layout="fill"
